<?php
/* Smarty version 3.1.29, created on 2017-06-06 20:22:39
  from "D:\myweb\websites\Blog\App\Back\View\Master\index.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59369e8f370931_97339537',
  'file_dependency' => 
  array (
    '75a10aef7696878b404e2bfabbed34364d1901b7' => 
    array (
      0 => 'D:\\myweb\\websites\\Blog\\App\\Back\\View\\Master\\index.html',
      1 => 1496751757,
      2 => 'file',
    ),
  ),
...
function content_59369e8f370931_97339537 ($_smarty_tpl) {
      ...
      <div class="tab-panel active" id="tab-set">
        <form method="post" class="form-x" action="index.php?p=Back&c=Master&a=edit" >
          <div class="form-group">
            <div class="label">
              <label for="sitename">Nick Name</label>
            </div>
            <div class="field">
...
" />
          ...
          <div class="form-group">
            <div class="label">
              <label for="siteurl">Home</label>
            </div>
            <div class="field">
              <input type="text" class="input" id="address" name="address" size="50" placeholder="请填写您的籍贯" data-validate="required:请填写您的籍贯" value="<?php echo $_smarty_tpl->tpl_vars['masterInfo']->value['home'];?>
" />
            </div>
          </div>
          <div class="form-group">
            <div class="label">
              <label for="siteurl">Tel</label>
            </div>
            <div class="field">
