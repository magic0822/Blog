<?php
/* Smarty version 3.1.29, created on 2017-05-11 10:51:02
  from "D:\myweb\websites\Blog\App\Back\View\Article\edit.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5913d196839cb8_67084764',
  'file_dependency' => 
  array (
    '48525d5cd13f56c335bb7ef8df679e030768ee02' => 
    array (
      0 => 'D:\\myweb\\websites\\Blog\\App\\Back\\View\\Article\\edit.html',
      1 => 1494471058,
      2 => 'file',
    ),
  ),
...
function content_5913d196839cb8_67084764 ($_smarty_tpl) {
      ...
      <div class="tab-panel active" id="tab-set">
        <form method="POST" class="form-x" action="index.php?p=Back&c=Article&a=dealEdit" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="title" name="title" size="50" placeholder="文章标题" data-validate="required:请填写您的文章标题" value="<?php echo $_smarty_tpl->tpl_vars['art']->value['title'];?>
"/>
            </div>
          </div>
          <div class="form-group">
...
?>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea name="content" id="ckeditor" class="input" rows="8" cols="50" placeholder="请填写文章内容" data-validate="required:请填写文章内容"><?php echo $_smarty_tpl->tpl_vars['art']->value['content'];?>
</textarea>
              <?php echo '<script'; ?>
